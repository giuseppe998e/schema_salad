    ...
    fn deserialize<D: de::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        impl de::Visitor<'_> for PrimitiveTypeVisitor {
            ...
            fn visit_bytes<E: de::Error>(self, v: &[u8]) -> Result<Self::Value, E> {
                match v {
                    b"null" => Ok(PrimitiveType::Null),
                    b"boolean" => Ok(PrimitiveType::Boolean),
                    b"int" => Ok(PrimitiveType::Int),
                    b"long" => Ok(PrimitiveType::Long),
                    b"float" => Ok(PrimitiveType::Float),
                    b"double" => Ok(PrimitiveType::Double),
